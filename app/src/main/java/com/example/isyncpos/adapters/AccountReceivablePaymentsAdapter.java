...
public class AccountReceivablePaymentsAdapter extends ListAdapter<Payments, AccountReceivablePaymentsAdapter.ViewHolder> {
    ...
    public AccountReceivablePaymentsAdapter(Activity activity){
        super(DIFF_CALLBACK);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        date = new Dates();
        return new AccountReceivablePaymentsAdapter.ViewHolder(view);
    }
                                ...
                                public void run() {
                                    ...
                                    try {
                                        ...
                                        if(paymentTypes.getIsAR() == 1){
                                            transactionsViewModel.updateTransactionAR(POSApplication.getInstance().getCurrentARTransactionId(), 0);
                                        }
                                    ...
                                    activity.runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            transactionsViewModel.setARCurrentTransaction(posProcess.recomputeCurrentARTransaction());
                                        }
                                    });
