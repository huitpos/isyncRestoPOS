...
public class AccountReceivableDiscountOtherInformationsObject {
    ...
    public AccountReceivableDiscountOtherInformationsObject(int machineId, int branchId, int companyId, int transactionId, int discountId, String name, String value, int isCutOff, int cutOffId, int isVoid, int isSentToServer, String treg) {
