...
public class CutOff {
    ...
    public CutOff(int machineNumber, int branchId, int readingNumber, String beginningOR, String endingOR, double beginningAmount, double endingAmount, int totalTransactions, double grossSales, double netSales, double vatableSales, double vatExemptSales, double vatAmount, double vatExpense, int voidQty, double voidAmount, double totalChange, double totalPayout, double totalServiceCharge, double totalDiscountAmount, double totalCost, double totalSK, int cashierId, String cashierName, int adminId, String adminName, int shiftNumber, int endOfDayId, int isSentToServer, String treg, double totalShortOver, double totalZeroRatedAmount, String printString, int isComplete, int companyId, double totalReturn) {
