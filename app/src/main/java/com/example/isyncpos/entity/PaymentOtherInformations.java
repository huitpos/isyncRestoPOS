...
public class PaymentOtherInformations {
    ...
    public PaymentOtherInformations(int machineId, int branchId, int transactionId, int paymentId, String name, String value, int isCutOff, int cutOffId, int isVoid, int isSentToServer, String treg, int companyId) {
