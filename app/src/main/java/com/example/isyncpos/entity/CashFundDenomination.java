...
public class CashFundDenomination {
    ...
    public CashFundDenomination(int machineNumber, int branchId, int cashFundId, int cashDenominationId, String name, double amount, int qty, double total, int isCutOff, int cutOffId, int endOfDayId, int isSentToServer, int shiftNumber, String treg, int companyId) {
