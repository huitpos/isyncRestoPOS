...
public class EndOfDayPayments {
    ...
    public EndOfDayPayments(int machineNumber, int branchId, int endOfDayId, int paymentTypeId, String name, int transactionCount, double amount, int isSentToServer, String treg, int companyId) {
