...
public class BranchDiscountOtherInformationsSyncPayload {
    ...
    public BranchDiscountOtherInformationsSyncPayload(int device_id, int discount_other_information_id, int pos_machine_id, int branch_id, int transaction_id, int discount_id, String name, String value, boolean is_cut_off, int cut_off_id, boolean is_void, boolean is_sent_to_server, String treg, int company_id) {
