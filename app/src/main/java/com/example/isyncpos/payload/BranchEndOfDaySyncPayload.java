...
public class BranchEndOfDaySyncPayload {

    private int device_id, end_of_day_id, pos_machine_id, branch_id, total_transactions, cashier_id, admin_id, is_sent_to_server, reading_number, void_qty, is_complete, beg_reading_number, end_reading_number, company_id;
    private String beginning_or, ending_or, cashier_name, admin_name, shift_number, treg, generated_date, print_string;
    ...
    private List<EndOffDayProducts> products;

    public BranchEndOfDaySyncPayload(int device_id, int end_of_day_id, int pos_machine_id, int branch_id, int total_transactions, int cashier_id, int admin_id, int is_sent_to_server, int reading_number, int void_qty, String beginning_or, String ending_or, String cashier_name, String admin_name, String shift_number, String treg, double beginning_amount, double ending_amount, double gross_sales, double net_sales, double vatable_sales, double vat_exempt_sales, double vat_amount, double vat_expense, double void_amount, double total_change, double total_payout, double total_service_charge, double total_discount_amount, double total_cost, double total_sk, double total_short_over, List<EndOffDayProducts> endOffDayProducts, int is_complete, String generated_date, int beg_reading_number, int end_reading_number, String print_string, int company_id, double total_return) {
        ...
        this.products = endOffDayProducts;
    ...
    public List<EndOffDayProducts> getProducts() {
        return products;
    }

    public void setProducts(List<EndOffDayProducts> products) {
