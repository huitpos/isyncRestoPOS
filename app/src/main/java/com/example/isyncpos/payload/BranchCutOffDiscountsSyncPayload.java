...
public class BranchCutOffDiscountsSyncPayload {

    private int device_id;
    private int cut_off_discount_id;
    ...
    public BranchCutOffDiscountsSyncPayload(int device_id, int cut_off_discount_id, int pos_machine_id, int branch_id, int cut_off_id, int discount_type_id, String name, int transaction_count, double amount, int end_of_day_id, boolean is_sent_to_server, String treg, boolean is_cut_off, int company_id, int is_zero_rated) {
        this.device_id = device_id;
        this.cut_off_discount_id = cut_off_discount_id;
    ...
    public int getCut_off_discount_id() {
        return cut_off_discount_id;
    }

    public void setCut_off_discount_id(int cut_off_discount_id) {
        this.cut_off_discount_id = cut_off_discount_id;
    }
