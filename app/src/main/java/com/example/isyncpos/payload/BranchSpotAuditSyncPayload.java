...
public class BranchSpotAuditSyncPayload {
    ...
    public BranchSpotAuditSyncPayload(int device_id, int spot_audit_id, int pos_machine_id, int branch_id, int company_id, String beginning_or, String ending_or, double beginning_amount, double ending_amount, int total_transactions, double gross_sales, double net_sales, double vatable_sales, double vat_exempt_sales, double vat_amount, double vat_expense, double void_qty, double void_amount, double total_change, double total_payout, double total_service_charge, double total_discount_amount, double total_cost, double safekeeping_amount, double safekeeping_short_over, double total_sk, double total_short_over, int cashier_id, String cashier_name, int admin_id, String admin_name, int shift_number, boolean is_cut_off, int cut_off_id, boolean is_sent_to_server, String treg) {
    ...
    public double getVoid_qty() {
        return void_qty;
    }

    public void setVoid_qty(double void_qty) {
        this.void_qty = void_qty;
    }
