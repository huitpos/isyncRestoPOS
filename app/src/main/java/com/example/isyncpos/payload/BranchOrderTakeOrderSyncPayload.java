...
public class BranchOrderTakeOrderSyncPayload {

    private int order_id, pos_machine_id, transaction_id, product_id, department_id, category_id, subcategory_id, unit_id, branch_id, cut_off_id;
