...
public class BranchCutOffDepartmentsSyncPayload {
    ...
    public BranchCutOffDepartmentsSyncPayload(int device_id, int cut_off_department_id, int pos_machine_id, int branch_id, int cut_off_id, int department_id, String name, double transaction_count, double amount, int end_of_day_id, boolean is_sent_to_server, String treg, boolean is_cut_off, int company_id) {
